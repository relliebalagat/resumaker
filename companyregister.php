...
?><br><br><br><br><br><br>
		...
		<table border = '1' >
		<tr>
			<th align = 'right'><font color = 'black'>Company Name:</font></th>
			<th><input type= 'text' class="form-control" name= 'cname' value= '<?php echo $_POST['cname'];?>'/></th>
		</tr>
		<tr>
			<th align = 'right'><font color = 'black'>Company Address:</font></th>
			<th><input type= 'text' class="form-control" name= 'caddress' value= '<?php echo $_POST['caddress'];?>'/></th>
		</tr>
		<tr>
			<th align = 'right'><font color = 'black'>Contact No:</font></th>
			<th><input type= 'text' class="form-control" name= 'ccontactno' value= '<?php echo $_POST['ccontactno'];?>'/></th>
		</tr>
		<tr>
			<th align = 'right'><font color = 'black'>Email:</font></th>
			<th><input type= 'number'  class="form-control" name= 'cemail' value= '<?php echo $_POST['cemail'];?>'/></th>
		</tr>
		<tr>
